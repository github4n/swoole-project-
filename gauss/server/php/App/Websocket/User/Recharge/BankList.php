...
class BankList extends CheckLogin
{
    public function onReceiveLogined(Context $context, Config $config)
    {
        ...
        $sql = "SELECT route_id,passage_id,risk_control,passage_name FROM deposit_route_bank_intact where  acceptable=1 AND passage_acceptable=1 AND find_in_set(:layer_id,layer_id_list)";
