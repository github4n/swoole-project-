 ...
 * @Author  Rose
 * @date  2019-04-29
 * @links  Cash/PayManage/PayBankEdit {"route_id":1}
 * @modifyAuthor   Rose
 * @modifyTime  2019-05-08
 *
 * */

class PayBankEdit extends CheckLogin
{
    public function onReceiveLogined(Context $context, Config $config)
    {
        ...
        $sql = 'SELECT * FROM deposit_route_bank_intact WHERE route_id=:route_id';
        ...
        if (!empty($info)) {
            ...
            $lists['passage_id'] = $info['passage_id'];
            ...
            $lists['coupon_rate'] = $info['coupon_rate'];
            $lists['coupon_max'] = $info['coupon_max'];
            $lists['coupon_times'] = $info['coupon_times'];
            $lists['coupon_audit_rate'] = $info['coupon_audit_rate'];
