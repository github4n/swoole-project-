...
/**
 * DepositGateCancel class.
 *
 * @description   现金系统-三方入款记录-未收到
 * @Author  Rose
 * @date  2019-04-26
 * @links  Cash/DepositRecord/DepositGateCancel {"deposit_serial":"181217155352000009"}
 * @modifyAuthor   blake
 * @modifyTime  2019-05-10
 *  status 1等待入款 2入款成功 3入款失败
 */
class DepositGateCancel extends CheckLogin
{
    public function onReceiveLogined(Context $context, Config $config)
    {
        ...
        $deposit_serial = !empty($data['deposit_serial']) ? $data['deposit_serial'] : '';
        ...
        $params = [
            ...
            ':detail' => '未收到入款单号为'.$deposit_serial.'的三方入款',
        ];
