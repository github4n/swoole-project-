...
/*
 *
 * @description  现金系统-出款审核-审核锁解锁
 * @Author  Rose
 * @date  2019-05-07
 * @links  Cash/WithdrawReview/ReviewUnlock {"user_key":"deal3","withdraw_serial":"181219105912000003"}
 * @modifyAuthor   Rose
 * @modifyTime  2019-05-08
 * */

class ReviewUnlock extends CheckLogin
{
    public function onReceiveLogined(Context $context, Config $config)
    {
        ...
        try {
            ...
            $context->reply(['status' => 400, 'msg' => '解锁失败']);
            throw new \PDOException($e);
        }
        $context->reply(['status' => 200, 'msg' => '解锁成功']);
        //记录操作日志
        ...
        $params = [
            ...
            ':detail' => '为单号为'.$withdraw_serial.'出款申请解审核锁',
        ];
