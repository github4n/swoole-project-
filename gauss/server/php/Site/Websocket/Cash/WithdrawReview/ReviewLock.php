...
/*
 *
 * @description  现金系统-出款审核-审核锁
 * @Author  Rose
 * @date  2019-05-07
 * @links  Cash/WithdrawReview/ReviewLock {"user_key":"deal3","withdraw_serial":"181219105912000003"}
 * @modifyAuthor   Rose
 * @modifyTime  2019-05-08
 * */

class ReviewLock extends CheckLogin
{
    public function onReceiveLogined(Context $context, Config $config)
    {
        ...
        $params = [
            ...
            ':detail' => '为单号为'.$withdraw_serial.'出款申请加审核锁',
        ];
