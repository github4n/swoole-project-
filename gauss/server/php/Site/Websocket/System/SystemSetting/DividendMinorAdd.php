...
/** 
* @description: 体系分红设置-新增股东体系分红比例
* @author： leo
* @date：   2019-04-08   
* @link：   System/SystemSetting/DividendMinorAdd {"minor_id":105,"minor_bet":"1","minor_profit":"1","minor_fee":"1","minor_tax":"1","agent_bet":"1","agent_profit":"1","agent_fee":"1","agent_tax":"1"}
...
class DividendMinorAdd extends CheckLogin
{
    public function onReceiveLogined(Context $context, Config $config)
    {
        ...
        if (!empty($scope_staff_id)){
            $context->reply(["status" => 204,"msg" => "该股东账号已添加分红设置，请勿重复添加"]);
            return;
        }
