...
/*
 *
 * @description   现金系统-删除银行卡入款通道
 * @Author  Rose
 * @date  2019-04-26
 * @links  Cash/DepositAccount/DepositBankDelete {"passage_id":2}
 * @modifyAuthor
 * @modifyDate
 *
 * */

class DepositBankDelete extends CheckLogin
{
    public function onReceiveLogined(Context $context, Config $config)
    {
        ...
        $sql = 'DELETE FROM deposit_passage_bank WHERE passage_id=:passage_id';
