...
/*
 *
 * @description  现金系统-支付管理-新增第三方入款通道
 * @Author  Rose
 * @date  2019-04-29
 * @links  Cash/PayManage/PayGateAddUpdate {"passage_id":2,"gate_way":[{"way_key":"alipay","way_name":"支付宝"}],"min_money":200,"max_money":5000,"acceptable":1,"level_id":["1","2","11"]}
 * @modifyAuthor   Rose
