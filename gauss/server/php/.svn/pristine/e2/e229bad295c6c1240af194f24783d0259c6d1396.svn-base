 ...
 * @description  现金系统-支付管理-新增银行卡入款通道
 * @Author  Rose
 * @date  2019-04-29
 * @links  Cash/PayManage/PayBankAddUpdate {"passage_id":1,"min_money":50,"max_money":5000,"acceptable":1,"level_id":["1"],"coupon_rate":0,"coupon_max":0,"coupon_times":0,"coupon_audit_rate":0}
 * @modifyAuthor   Rose
...
class PayBankAddUpdate extends CheckLogin
{
    public function onReceiveLogined(Context $context, Config $config)
    {
        ...
        $param = [
            ...
            ':coupon_audit_rate' => $coupon_audit_rate,
        ];
        try {
