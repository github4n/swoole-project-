...
/*
 * @description    现金系统-入款账户管理-删除便捷支付
 * @Author  Rose
 * @date  2019-04-26
 * @links Cash/DepositAccount/DepositSimpleDelete
 * @modifyAuthor
 * @modifyDate
 *
 * */

class DepositSimpleDelete extends CheckLogin
{
    public function onReceiveLogined(Context $context, Config $config)
    {
        ...
        $sql = 'DELETE FROM deposit_passage_simple WHERE passage_id=:passage_id';
