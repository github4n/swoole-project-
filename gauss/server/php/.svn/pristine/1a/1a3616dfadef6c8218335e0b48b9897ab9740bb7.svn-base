...
class AlipayList extends CheckLogin
{
    public function onReceiveLogined(Context $context, Config $config)
    {
        ...
        $sql = "SELECT route_id,passage_name,min_money,max_money FROM deposit_route_gateway_intact WHERE find_in_set(:layer_id,layer_id_list) AND passage_acceptable=1 AND way_key='alipay'";
