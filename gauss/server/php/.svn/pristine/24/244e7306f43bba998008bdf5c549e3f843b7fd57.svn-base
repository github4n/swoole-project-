...
/*
 *
 * @description  现金系统-支付管理-第三方入款通道
 * @Author  Rose
 * @date  2019-04-29
 * @links  Cash/PayManage/PayGateAdd
 * @modifyAuthor   Rose
 * @modifyTime  2019-05-08
 * */

class PayGateAdd extends CheckLogin
{
    public function onReceiveLogined(Context $context, Config $config)
    {
        ...
        //查找入款通道信息
        $sql = 'SELECT passage_id,account_name FROM deposit_passage_gate_intact  where acceptable = 1';
