...
$services = [
    "plat0admin" => [
        "config" => [
            ...
            "site_list" => [],
            "fg_apiurl" => "https://api.ppro.98078.net",
            "fg_merchantname" => "uat_gongying1214",
            "fg_merchantcode" => "196f947f9c00ee8e20af23cc0d5b5926",
            "fg_partnerid" => "kma61Eku",
            "fg_apikey" => "eYqydWb4UdNewXZqyOPxY3kGxTEtB4IC",
            "ky_apiurl" => "https://kyapi.ky206.com:189/channelHandle",
            "ky_recordurl" => "https://kyrecord.ky206.com:190/getRecordHandle",
            "ky_agent" => "70703",
            "ky_deskey" => "A912B25D61265D4F",
            "ky_md5key" => "15B4FAC38BA8FB2A",
            "ag_giurl" => "gi.3883ag.com",
            "ag_gciurl" => "gci.3883ag.com",
            "ag_cagent" => "DP6_AGIN",
            "ag_md5key" => "rZQsKP7eawmy",
            "ag_deskey" => "swf2AHPv",
            "ag_ftpurl" => "ftp://xd.gdcapi.com",
            "ag_ftpusr" => "DP6.gongying",
            "ag_ftppwd" => "4ql8RdTZcu",
            "lb_vendorid" => "fmhw2qeg5h",
            "lb_weburl" => "http://sbtest.lebotiyi.com/",
            "lb_wapurl" => "http://smartsbtest.lebotiyi.com/",
            "lb_apiurl" => "http://tsa.lebotiyi.com/api",
        ],
        "processes" => [
            "PlatHttp" => 1,
            "PlatWebsocket" => 2,
