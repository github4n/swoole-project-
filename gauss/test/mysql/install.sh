...
replace into tables_priv(host,db,user,table_name,grantor,table_priv)
    select '%','${SCHEMA}','master_${SCHEMA}',table_name,user(),'select,insert,update,delete'
